...
- (instancetype)initWithCameraName:(NSString *)cameraName
    ...
    // Change framerate to 15 FPS
    if ( [_captureDevice lockForConfiguration:NULL] == YES ) {
        _captureDevice.activeVideoMinFrameDuration = CMTimeMake(1, 15);
        _captureDevice.activeVideoMaxFrameDuration = CMTimeMake(1, 15);
...
- (BOOL)setupWriterForPath:(NSString *)path {
    ...
    //                                 [NSNumber numberWithInt:1280], AVVideoHeightKey, @{AVVideoAverageBitRateKey : [NSNumber numberWithInt: 100000]}, AVVideoCompressionPropertiesKey,
    //                                   nil];
    
    NSDictionary *videoSettings = [NSDictionary
                                   dictionaryWithObjectsAndKeys:AVVideoCodecH264, AVVideoCodecKey,
                                   [NSNumber numberWithInt:720], AVVideoWidthKey,
                                   [NSNumber numberWithInt:1280], AVVideoHeightKey, @{AVVideoAverageBitRateKey : [NSNumber numberWithInt: 3500000]}, AVVideoCompressionPropertiesKey,
                                   nil];
